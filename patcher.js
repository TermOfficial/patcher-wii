...
const ROOM_LEGACY = "legacy";
const ROOM_JD2015 = "jd2015";
const ROOM_JD5 = "jd5";
...
// Use the same strings from main STRINGS but keep the JD15 room name
const STRINGS_JD2015 = {
  ...STRINGS,
  'legacy': ROOM_JD2015
};
...
module.exports = (inputDolPath) => {
  ...
  // If version is 2015, replace STRINGS with STRINGS_JD2015
  if (jdVersion === 2015) STRINGS_USED = STRINGS_JD2015;
